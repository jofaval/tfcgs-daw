...
<div class="container p-0">
    ...
    <div
        ...
        <div class="md-form input-group col my-2">
            <input type="search" class="form-control pl-0 rounded-0" name="search" id="search" placeholder="Search...">
        ...
        <div class="row projectCardRow d-flex justify-content-center m-0">
            <div class="projectCard row col m-2 bg-white">
                <div
                    ...
                    <div class="btn btn-sm btn-primary">Go to project</div>
                ...
                <div class="projectCardDescription text-justify my-2">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam repellendus voluptatem, dolorum
