...
class POPOcontroller
{
    ...
    {
        $popoInstance = new GanttDiagramGroupTaskAssignation();
    ...
    {
        $popoInstance = new GanttDiagramGroupTasks();
    ...
    {
        $popoInstance = new GanttDiagramGroups();
    ...
    {
        $popoInstance = new TaskListItemListItems();
    ...
    {
        $popoInstance = new TaskListItemLists();
    ...
    {
        $popoInstance = new TaskListsOrderCriteria();
