...
<a href="<?php echo $action["link"]; ?>"
    class="action action<?php echo $action["id"]; ?>Phone d-sm-none w-100 cursor-pointer px-0 shadow-none hoverable <?php echo $action["color"]; ?> m-2"
    ...
    <div class="actionTitle h-25 w-100 text-center d-flex justify-content-center py-2 text-white bg-dark">
