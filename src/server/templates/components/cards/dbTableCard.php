<a href="<?php echo Config::$EXECUTION_HOME_PATH; ?>admin/get-data-from-table/<?php echo $tableName ?>/"
    class="dbTableCard text-light col-12 p-0 m-2 col-sm bg-dark ">
    ...
    <div class="row dbTableCardDetails pl-3 z-index-overlap flex-wrap center-elements w-100 m-0 pt-2 p-5">
        <h5 class="dbTableCardTitle text-light m-0 font-weight-bold">
