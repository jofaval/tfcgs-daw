...
<?php require_once SystemPaths::SERVER_COMPONENTS_PATH . "/headProject.php"?>
...
<body scroll="no" class="text-light position-fixed w-100 h-100 overflow-hidden"
    ...
    <?php if ($showHeader):
    require_once SystemPaths::SERVER_COMPONENTS_PATH . "/header.php";
endif;?>
    ...
    <?php if ($showFooter): require_once SystemPaths::SERVER_COMPONENTS_PATH . "/footerProject.php";endif;?>
    <?php require_once SystemPaths::SERVER_COMPONENTS_PATH . "/loader.php";?>
</body>
