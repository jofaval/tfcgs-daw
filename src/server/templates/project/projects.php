...
<div class="w-100 p-0">
    <div class="row py-5 m-0 projectHeader pr-sm-5">
        ...
        <div class="d-none d-sm-block projectDetails bg-dark rounded text-dark col">
            ...
            <p class="projectCreatedBy mb-2"><a id="projectCreator"
                    ...
                    class="text-dark"><?php echo $viewParams["profile"]["website"]; ?></a></p>
            ...
            <a href="<?php echo Config::$EXECUTION_HOME_PATH; ?>profile/<?php echo $username; ?>/" class="text-dark">
                <span><i class="fa fa-eye"></i></span>&nbsp;Ver perfil</a>
            &nbsp;
            <a href="<?php echo Config::$EXECUTION_HOME_PATH; ?>profile/" class="text-dark">
                <span><i class="fa fa-pencil"></i></span>&nbsp;Editar perfil </a>
        </div>
    </div>
    <div
        class="row tabs d-flex text-dark justify-content-center justify-items-center align-content-center align-items-center shadow w-100 m-0 tabs">
        ...
        <div class="row w-auto mx-2">
            <p class="m-0 align-self-center text-dark">Mostrar&nbsp;</p>
            ...
            <p class="m-0 align-self-center text-dark">&nbsp;fila(s).</p>
        </div>
        <div class="btn btn-success btn-sm projectBtnAdd">+ Añadir</div>
        <div class="md-form input-group col-12 col-sm my-2">
            <input type="search" class="form-control text-dark pl-0 rounded-0" name="projectSearch" id="projectSearch"
                placeholder="Buscar...">
    ...
    <div class="tabContentContainer m-0 mx-auto px-2 pt-2">
        <div class="projectsContainer text-dark text-center col-md-10 m-0 mx-auto">
        </div>
