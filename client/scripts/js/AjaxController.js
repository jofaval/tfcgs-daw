class AjaxController {
    ...
    static createDashboardsItemAssignation(id, id_dashboard_item, assigned_by, start_date, end_date, creation_date, assigned_to) {
        AjaxController.genericAjaxRequest("createDashboardsItemAssignation", {
            "id": id,
    ...
    static updateDashboardsItemAssignation(id, id_dashboard_item, assigned_by, start_date, end_date, creation_date, assigned_to) {
        AjaxController.genericAjaxRequest("updateDashboardsItemAssignation", {
            "id": id,
            "id_dashboard_item": id_dashboard_item,
            "assigned_by": assigned_by,
            "start_date": start_date,
    ...
    static queryDashboardsItemAssignation(id) {
        AjaxController.genericAjaxRequest("queryDashboardsItemAssignation", {
            "id": id,
        }, success);
    }

    //Function to deleteDashboardsItemAssignation
    static deleteDashboardsItemAssignation(id) {
        AjaxController.genericAjaxRequest("deleteDashboardsItemAssignation", {
            "id": id,
        }, success);
    }
}