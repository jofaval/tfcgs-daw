<div class="recentlyCard text-dark row col-12 rounded px-0 col-sm m-2 bg-white">
    <div
        ...
        <div class="recentlyCardFlags ml-auto btn-group">
            <a href="/daw/client/projects/id/<?php echo $viewParams["id"]; ?>/dashboards/<?php echo $recentlyCreated["dashboard_title"]; ?>/task/id/<?php echo $recentlyCreated["id"]; ?>/"
    ...
    <p class="recentlyCardDescription text-dark text-overflow-ellipsis pl-3 overflow-hidden text-justify my-2">
        ...
        <span class="creatorDetail">por&nbsp;<a href="/daw/client/profile/<?php echo $recentlyCreated["username"] ?>"
