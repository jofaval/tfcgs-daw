<div class="card">
    <!-- <img class="card-img-top"
        src="/daw/client/img/projects/<?php /* echo $viewParams["id"]; */?>/dashboards/<?php /* echo $assignedTask["dashboard_title"]; */?>/bg.png"
        alt="Card image cap" height="50"> -->
    <div class="card-body">
        <div class="assignedByContainer text-dark float-right">
            Asignado por&nbsp;<a href="/daw/client/profile/<?php echo $assginedByUsername ?>"
                class=""><?php echo $assginedByUsername; ?></a>&nbsp;a&nbsp;<a
                href="/daw/client/profile/<?php echo $assginedtoUsername ?>" class=""><?php echo $assginedtoUsername; ?></a>
        </div>

        <h4 class="card-title max-width-20 text-dark">
            <a href="/daw/client/projects/id/<?php echo $viewParams["id"]; ?>/dashboards/<?php echo $assignedTask["dashboard_title"]; ?>/"
