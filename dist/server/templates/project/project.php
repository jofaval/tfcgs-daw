...
<div class="w-100 p-0">
    ...
    <div class="row tabs shadow w-100 m-0 text-white">
        <a href="/daw/client/projects/id/<?php echo $viewParams["id"]; ?>/overview/" id="tabOverview"
        ...
        <a href="/daw/client/projects/id/<?php echo $viewParams["id"]; ?>/dashboards/" id="tabDashboards"
        ...
        <a href="/daw/client/projects/id/<?php echo $viewParams["id"]; ?>/diary/" id="tabDiary"
        ...
        <a href="/daw/client/projects/id/<?php echo $viewParams["id"]; ?>/collaborators/" id="tabCollaborators"
        ...
        <a href="/daw/client/projects/id/<?php echo $viewParams["id"]; ?>/details/" id="tabDetails"
...
$breadcrumb[] = [
    ...
    "link" => "/daw/client/projects/id/" . $viewParams["id"] . "/$tabName/",
    "active" => true,
    "icon" => $icon,
];
?>
